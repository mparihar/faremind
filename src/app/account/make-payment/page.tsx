      ...
      <div className="max-w-lg mx-auto py-16 text-center">
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: 'spring', duration: 0.5 }}>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <button onClick={() => router.push('/account/support')} className="px-6 py-2.5 rounded-xl bg-white/[0.06] border border-white/[0.08] text-white font-semibold text-sm hover:bg-white/[0.1] transition-all">
              View My Tickets
            </button>
            <button onClick={() => router.push('/account')} className="px-6 py-2.5 rounded-xl bg-white/[0.06] border border-white/[0.08] text-white font-semibold text-sm hover:bg-white/[0.1] transition-all">
              Dashboard
            </button>
