    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-white/10 shadow-2xl">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16 gap-4">
          {/* Logo */}
          <Link href="/" className="flex items-center group h-16 w-fit">
            ...
            <div className="hidden md:flex items-center gap-2 ml-auto">
              ...
              {user ? (
                ...
                <div className="flex items-center gap-2">
                  <Link
                    href="/agent/login"
                    className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold text-white/50 hover:text-white/80 border border-white/10 hover:border-white/20 transition-all"
                  >
                  ...
                  {user ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <Link
                        href="/agent/login"
                        onClick={() => setMobileOpen(false)}
                        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-white/50 hover:text-white/80 border border-white/10"
                      >
