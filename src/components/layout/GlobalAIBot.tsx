...
export default function GlobalAIBot() {
  ...
  // Hide on admin, auth, agent login pages, and /search (full bot renders there)
  ...
  return (
    <div className="fixed z-50 flex flex-col items-start gap-3 bottom-14 sm:bottom-16 left-4 sm:left-6">
      ...
      {/* Floating trigger button — unified style */}
